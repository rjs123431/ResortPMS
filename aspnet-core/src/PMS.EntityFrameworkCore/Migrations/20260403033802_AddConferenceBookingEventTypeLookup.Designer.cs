...
namespace PMS.Migrations
{
    ...
    [Migration("20260403033802_AddConferenceBookingEventTypeLookup")]
    partial class AddConferenceBookingEventTypeLookup
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("PMS.App.ConferenceBooking", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.Property<Guid?>("ConferenceCompanyId")
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.Property<int>("TeardownBufferMinutes")
                        .HasColumnType("int");
                    ...
                    b.ToTable("ConferenceBooking", (string)null);
                });

            modelBuilder.Entity("PMS.App.ConferenceBookingAddOn", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.Property<Guid>("ConferenceBookingId")
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.ToTable("ConferenceBookingAddOn", (string)null);
                });

            modelBuilder.Entity("PMS.App.ConferenceBookingPayment", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.ToTable("ConferenceBookingPayment", (string)null);
                });

            modelBuilder.Entity("PMS.App.ConferenceCompany", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.ToTable("ConferenceCompany", (string)null);
                });

            modelBuilder.Entity("PMS.App.ConferenceExtra", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.ToTable("ConferenceExtra", (string)null);
                });

            modelBuilder.Entity("PMS.App.ConferenceVenue", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.ToTable("ConferenceVenue", (string)null);
                });

            modelBuilder.Entity("PMS.App.ConferenceVenueBlackout", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.ToTable("ConferenceVenueBlackout", (string)null);
                });

            modelBuilder.Entity("PMS.App.DayUseOffer", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.HasIndex("GuestContext", "OfferType", "SortOrder");

                    b.ToTable("DayUseOffer", (string)null);
                });

            modelBuilder.Entity("PMS.App.DayUsePayment", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.HasIndex("DayUseVisitId", "PaidAt");

                    b.ToTable("DayUsePayment", (string)null);
                });

            modelBuilder.Entity("PMS.App.DayUseVisit", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");

                    b.Property<TimeSpan>("AccessEndTime")
                        .HasColumnType("time");

                    b.Property<TimeSpan>("AccessStartTime")
                        .HasColumnType("time");
                    ...
                    b.HasIndex("VisitDate", "GuestContext");

                    b.ToTable("DayUseVisit", (string)null);
                });

            modelBuilder.Entity("PMS.App.DayUseVisitLine", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.HasIndex("DayUseOfferId");

                    b.HasIndex("DayUseVisitId");

                    b.ToTable("DayUseVisitLine", (string)null);
                });
            ...
            modelBuilder.Entity("PMS.App.EventType", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("PMS.App.ConferenceBooking", b =>
                {
                    b.HasOne("PMS.App.ConferenceCompany", "ConferenceCompany")
                        .WithMany()
                    ...
                    b.HasOne("PMS.App.ConferenceVenue", "Venue")
                        .WithMany()
            ...
            modelBuilder.Entity("PMS.App.ConferenceBookingAddOn", b =>
                {
                    b.HasOne("PMS.App.ConferenceBooking", "ConferenceBooking")
                        .WithMany("AddOns")
            ...
            modelBuilder.Entity("PMS.App.DayUsePayment", b =>
                {
                    b.HasOne("PMS.App.DayUseVisit", "DayUseVisit")
                        .WithMany("Payments")
                        .HasForeignKey("DayUseVisitId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();
            ...
            modelBuilder.Entity("PMS.App.DayUseVisitLine", b =>
                {
                    ...
                    b.HasOne("PMS.App.DayUseOffer", "DayUseOffer")
                        .WithMany()
                        .HasForeignKey("DayUseOfferId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();
