...
export const AdminSidebar: React.FC<AdminSidebarProps> = ({ isOpen, onClose }) => {
  ...
  const [expandedMenus, setExpandedMenus] = useState<string[]>(['Property Setup', 'Administration']);
    ...
    () => [
      ...
      },
      {
        ...
        children: [
          ...
          { path: `${base}/day-use-offers`, label: 'Day Use Offers', permissions: [PermissionNames.Pages_DayUse_Admin], icon: <svg className="h-4 w-4" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M9 14l6-6m-5 0h5v5M5 3h14a2 2 0 012 2v14a2 2 0 01-2 2H5a2 2 0 01-2-2V5a2 2 0 012-2z" /></svg> },
  ...
  const isActive = (path: string) => location.pathname === path || (path !== '/' && path !== base && location.pathname.startsWith(`${path}/`));
