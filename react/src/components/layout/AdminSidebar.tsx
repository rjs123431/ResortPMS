...
export const AdminSidebar: React.FC<AdminSidebarProps> = ({ isOpen, onClose }) => {
  ...
  const [expandedMenus, setExpandedMenus] = useState<string[]>(['Setup', 'Administration']);
  ...
  const menuItems: MenuItem[] = useMemo(
    () => [
      ...
      },
      {
        ...
        children: [
          { path: `${base}/guests`, label: 'Guests', permissions: [PermissionNames.Pages_Guests], icon: <svg className="h-4 w-4" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M17 20h5V4H2v16h5m10 0v-4a3 3 0 00-3-3H10a3 3 0 00-3 3v4m10 0H7m10-9a4 4 0 11-8 0 4 4 0 018 0z" /></svg> },
          { path: `${base}/rooms`, label: 'Rooms', permissions: [PermissionNames.Pages_Rooms], icon: <svg className="h-4 w-4" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M3 7h18M5 7V5a2 2 0 012-2h10a2 2 0 012 2v2m0 0v10a2 2 0 01-2 2H7a2 2 0 01-2-2V7m4 6h6" /></svg> },
          ...
          { path: `${base}/agencies`, label: 'Agencies', permissions: [PermissionNames.Pages_Agencies], icon: <svg className="h-4 w-4" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M4 6h16M4 12h16M4 18h7" /></svg> },
