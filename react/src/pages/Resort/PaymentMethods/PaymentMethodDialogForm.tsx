...
type PaymentMethodDialogFormProps = {
  isOpen: boolean;
...
export const PaymentMethodDialogForm = ({
  isOpen,
  editingId,
  form,
  canCreate,
    ...
    <Dialog open={isOpen} onClose={onClose} className="fixed inset-0 z-50 overflow-y-auto">
      <div className="flex min-h-screen items-center justify-center bg-black/50 p-4">
        <DialogPanel className="w-full max-w-lg rounded-lg bg-white p-5 shadow-xl dark:bg-gray-800">
          ...
          <div>
            <label className="mb-1 block text-sm font-medium text-gray-700 dark:text-gray-300">Payment Method Name</label>
