...
export const RoomRackDetailPanel: React.FC<RoomRackDetailPanelProps> = ({ open, onClose, item }) => {
  ...
  return (
    <aside
      className={`fixed top-12 right-0 bottom-[3.3rem] z-40 w-full max-w-md flex flex-col bg-white dark:bg-gray-800 shadow-xl border-l border-gray-200 dark:border-gray-700 overflow-hidden transition-transform duration-300 ease-out ${
